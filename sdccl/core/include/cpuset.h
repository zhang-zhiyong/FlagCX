...
#ifndef SDCCL_CPUSET_H_
#define SDCCL_CPUSET_H_
...
static sdcclResult_t sdcclStrToCpuset(const char *str, cpu_set_t *mask) {
...
static sdcclResult_t sdcclCpusetToStr(cpu_set_t *mask, char *str) {
  int c = 0;
