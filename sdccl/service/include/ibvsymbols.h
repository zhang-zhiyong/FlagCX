...
#ifndef SDCCL_IBV_SYMBOLS_H_
#define SDCCL_IBV_SYMBOLS_H_
...
sdcclResult_t buildIbvSymbols(struct sdcclIbvSymbols *ibvSymbols);

#endif // SDCCL_IBV_SYMBOLS_H_